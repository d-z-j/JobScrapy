...
from myCrawling.items import MycrawlingItem2


class Zhaopin2Spider(scrapy.Spider):
    name = "zhaopin2"
    allowed_domains = ["zhaopin.com"]
    start_urls = ["https://sou.zhaopin.com/?jl=530&kw=python&p=1"]
    def start_requests(self):
        for i in range(1,21):
            yield Request(url=f'https://sou.zhaopin.com/?jl=576&kw=python&p={i}')
    custom_settings = {
        'ITEM_PIPELINES' : {'myCrawling.pipelines.MycrawlingPipeline2': 300}
    }
